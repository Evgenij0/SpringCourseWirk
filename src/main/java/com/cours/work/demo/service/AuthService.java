...
import com.cours.work.demo.configuration.security.JwtService;
...
import com.cours.work.demo.token.Token;
import com.cours.work.demo.token.TokenRepository;
import com.cours.work.demo.token.TokenType;
...
public class AuthService {
    ...
    private void regAdmin() {
        if (repository.findByEmail("admin@mail.com").isPresent()) return;
